...
var createNewTaskElement=function(taskString){
    ...
    listItem.classList.add('list-view');

    //input (checkbox)
    var checkBox=document.createElement("input");//checkbx
    checkBox.classList.add('input_type_checkbox');
    //label
    ...
    deleteButtonImg.classList.add('icon_remove')
...
var editTask=function(){
    ...
    //If class of the parent is .tasks_edit-mode
    if(containsClass){

        //switch to .tasks_edit-mode
    ...
    //toggle .tasks_edit-mode on the parent.
